          ...
          [
            {
              ...
              "extract": true,
              "stripComponents": 1,
              "targetDir": "~/.nemo/tools/sherpa-onnx-tts/runtime",
            ...
            },
            {
              ...
              "archive": "tar.bz2",
              "extract": true,
              "targetDir": "~/.nemo/tools/sherpa-onnx-tts/models",
...
1. Download the runtime for your OS (extracts into `~/.nemo/tools/sherpa-onnx-tts/runtime`)
2. Download a voice model (extracts into `~/.nemo/tools/sherpa-onnx-tts/models`)

Update `~/.nemo/nemo.json`:
...
```json5
{
  skills: {
    entries: {
      "sherpa-onnx-tts": {
        env: {
          SHERPA_ONNX_RUNTIME_DIR: "~/.nemo/tools/sherpa-onnx-tts/runtime",
          SHERPA_ONNX_MODEL_DIR: "~/.nemo/tools/sherpa-onnx-tts/models/vits-piper-en_US-lessac-high",
        },
      },
    },
  },
