...
- **GitHub:** https://github.com/nemo/nemo
- **Discord:** https://discord.gg/qkhbAGHRBT
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@nemo](https://x.com/nemo)
...
2. **New features / architecture** → Start a [GitHub Discussion](https://github.com/nemo/nemo/discussions) or ask in Discord first
3. **Questions** → Discord #setup-help

## Before You PR

- Test locally with your NEMO instance
...
- **Skills**: For skill contributions, head to [NEMOHub](https://nemohub.ai/) — the community hub for NEMO skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/nemo/nemo/issues) for "good first issue" labels!
