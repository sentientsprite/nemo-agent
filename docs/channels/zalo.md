...
- Install via CLI: `nemo plugins install @nemo/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `nemo plugins install ./extensions/zalo`
   - From npm (if published): `nemo plugins install @nemo/zalo`
...
- Approve via:
  - `nemo pairing list zalo`
  - `nemo pairing approve zalo <CODE>`
...
- Example: `nemo message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `nemo channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `nemo logs --follow`
