---
summary: "NEMOnet refactor: unify network protocol, roles, auth, approvals, identity"
read_when:
...
title: "NEMOnet Refactor"
---

# NEMOnet refactor (protocol + auth unification)
...
- Example: `scarlet-nemo`, `saltwave`, `mantis-pinch`.
