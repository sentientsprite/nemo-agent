...
This guide summarizes a sane workflow for working on the pi integration in NEMO.
...
- Trigger the agent directly:
  - `pnpm nemo agent --message "Hello" --thinking low`
...
State lives under the NEMO state directory. Default is `~/.nemo`. If `NEMO_STATE_DIR` is set, use that directory instead.

To reset everything:

- `nemo.json` for config
...
- [https://docs.nemo.ai/testing](https://docs.nemo.ai/testing)
- [https://docs.nemo.ai/start/getting-started](https://docs.nemo.ai/start/getting-started)
