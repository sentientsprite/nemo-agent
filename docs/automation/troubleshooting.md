...
nemo system heartbeat last
nemo logs --follow
nemo config get agents.defaults.heartbeat
nemo channels status --probe
```
...
```bash
nemo config get agents.defaults.heartbeat.activeHours
nemo config get agents.defaults.heartbeat.activeHours.timezone
nemo config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
nemo cron list
nemo logs --follow
```
