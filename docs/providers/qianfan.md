---
summary: "Use Qianfan's unified API to access many models in NEMO"
read_when:
...
3. NEMO installed on your system
...
4. Copy the API key for use with NEMO

## CLI setup

```bash
nemo onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [NEMO Configuration](/gateway/configuration)
