...
You can point NEMO at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or NEMO
...
- [Anthropic provider](/providers/anthropic) - Native NEMO integration with Claude setup-token or API keys
