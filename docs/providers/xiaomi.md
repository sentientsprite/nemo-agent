---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with NEMO"
read_when:
  - You want Xiaomi MiMo models in NEMO
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). NEMO uses
