---
summary: "Use Synthetic's Anthropic-compatible API in NEMO"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. NEMO registers it as the
...
Note: NEMO's Anthropic client appends `/v1` to the base URL, so use
