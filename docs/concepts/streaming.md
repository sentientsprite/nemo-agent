...
NEMO has two separate “streaming” layers:
...
When block streaming is enabled, NEMO can **merge consecutive block chunks**
...
When draft streaming is active, NEMO disables block streaming for that reply to avoid double-streaming.
