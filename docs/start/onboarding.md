---
summary: "First-run onboarding flow for NEMO (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give NEMO">
...
<Step title="CLI">
  ...
  The app can install the global `nemo` CLI via npm/pnpm so terminal
