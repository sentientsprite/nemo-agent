---
summary: "Overview of NEMO onboarding options and flows"
read_when:
...
NEMO supports multiple onboarding paths depending on where the Gateway runs
...
- [`nemo onboard` command](/cli/onboard)

## macOS app onboarding

Use the NEMO app when you want a fully guided setup on macOS. Docs:
