...
NEMO treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.nemo/settings/voicewake.json`

Shape:

```json
{ "triggers": ["nemo", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
