...
read_when:
  - You are building a NEMO plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (nemo.plugin.json)

Every plugin **must** ship a `nemo.plugin.json` file in the **plugin root**.
NEMO uses this manifest to validate configuration **without executing plugin
