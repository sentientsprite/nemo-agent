...
final class ScreenController {
    ...
    /// Callback invoked when an nemo:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = NEMOKitResources.bundle
...
/// Handles navigation policy to intercept nemo:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept nemo:// deep links.
        if url.scheme?.lowercased() == "nemo" {
