...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: NEMOPhotosLatestParams) async throws -> NEMOPhotosLatestPayload {
        ...
        return NEMOPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> NEMOPhotoPayload
    {
