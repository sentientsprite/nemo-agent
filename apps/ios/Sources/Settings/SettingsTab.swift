...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = NEMOLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = NEMOLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.nemo.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(NEMOLocationMode.off.rawValue)
                            Text("While Using").tag(NEMOLocationMode.whileUsing.rawValue)
                            Text("Always").tag(NEMOLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while NEMO is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = NEMOLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: NEMOLocationMode {
        NEMOLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
