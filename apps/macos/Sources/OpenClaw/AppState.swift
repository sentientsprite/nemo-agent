...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = NEMOConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = NEMOConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = NEMOConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/nemo"
        state.remoteCliPath = ""
        return state
    }
}
