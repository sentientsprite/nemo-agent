...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .nemoSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? NEMOPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? NEMOPaths.stateDirURL.path
...
extension Notification.Name {
    static let nemoSelectSettingsTab = Notification.Name("nemoSelectSettingsTab")
}
