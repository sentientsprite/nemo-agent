...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/nemo/nemo") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/nemo/nemo")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://nemo.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "NEMOBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "NEMOBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "NEMOGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "NEMOGitCommit") as? String) ??
            "unknown"
    }
