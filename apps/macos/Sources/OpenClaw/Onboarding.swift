...
enum UIStrings {
    static let welcomeTitle = "Welcome to NEMO"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: NEMOOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: NEMOChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g nemo@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: NEMOChatViewModel(
