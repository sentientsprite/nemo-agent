...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.nemo", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other NEMO windows, but below the system’s pop-up menus.
