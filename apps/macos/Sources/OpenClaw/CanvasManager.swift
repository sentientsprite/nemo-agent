...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.nemo", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("NEMO/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__nemo__/a2ui/").absoluteString + "?platform=macos"
    }
