...
enum DebugActions {
    private static let verboseDefaultsKey = "nemo.debug.verboseMain"
    private static let sessionMenuLimit = 12
    private static let onboardingSeenKey = "nemo.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "NEMO", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = NEMOPaths.configURL
        guard
