...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.nemo", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        NEMOPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        NEMOPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
