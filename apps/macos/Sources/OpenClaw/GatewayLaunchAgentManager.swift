...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.nemo", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".nemo/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.nemoCommand(
            subcommand: "gateway",
