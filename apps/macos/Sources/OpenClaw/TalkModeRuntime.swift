...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.nemo", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.nemo", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [NEMOChatMessage] = messages.compactMap { item in
