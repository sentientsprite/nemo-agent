...
import "@a2ui/lit/ui";
import { themeContext } from "@nemo/a2ui-theme-context";
...
class NEMOA2UIHost extends LitElement {
  static properties = {
    surfaces: { state: true },
  ...
  static styles = css`
    :host {
      ...
      padding:
        var(--nemo-a2ui-inset-top, 0px)
        var(--nemo-a2ui-inset-right, 0px)
        var(--nemo-a2ui-inset-bottom, 0px)
        var(--nemo-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--nemo-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--nemo-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--nemo-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--nemo-a2ui-empty-top, var(--nemo-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  connectedCallback() {
    ...
    globalThis.nemoA2UI = api;
    this.addEventListener("a2uiaction", (evt) => this.#handleA2UIAction(evt));
    this.#statusListener = (evt) => this.#handleActionStatus(evt);
    for (const eventName of ["nemo:a2ui-action-status"]) {
  ...
  #handleA2UIAction(evt) {
    ...
    if (handler?.postMessage) {
      try {
        ...
        if (handler === globalThis.nemoCanvasA2UIAction) {
...
if (!customElements.get("nemo-a2ui-host")) {
  customElements.define("nemo-a2ui-host", NEMOA2UIHost);
}
