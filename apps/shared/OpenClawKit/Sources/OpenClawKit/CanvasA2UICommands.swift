...
public enum NEMOCanvasA2UICommand: String, Codable, Sendable {
...
public struct NEMOCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct NEMOCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
