...
public enum NEMOTalkCommand: String, Codable, Sendable {
...
public struct NEMOTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct NEMOTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
