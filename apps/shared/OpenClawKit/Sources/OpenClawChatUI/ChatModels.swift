...
public typealias NEMOPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias NEMOPlatformImage = UIImage
#endif

public struct NEMOChatUsageCost: Codable, Hashable, Sendable {
...
public struct NEMOChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: NEMOChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(NEMOChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct NEMOChatMessageContent: Codable, Hashable, Sendable {
...
public struct NEMOChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [NEMOChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: NEMOChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [NEMOChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: NEMOChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(NEMOChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([NEMOChatMessageContent].self, forKey: .content) {
...
public struct NEMOChatHistoryPayload: Codable, Sendable {
...
public struct NEMOSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct NEMOSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [NEMOSessionPreviewItem]
}

public struct NEMOSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [NEMOSessionPreviewEntry]

    public init(ts: Int, previews: [NEMOSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct NEMOChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct NEMOChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct NEMOAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct NEMOChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct NEMOGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct NEMOPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: NEMOPlatformImage?
...
public struct NEMOChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
