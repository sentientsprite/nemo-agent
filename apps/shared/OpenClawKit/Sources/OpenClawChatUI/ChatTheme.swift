...
enum NEMOPlatformImageFactory {
    static func image(_ image: NEMOPlatformImage) -> Image {
        #if os(macOS)
        Image(nsImage: image)
        #else
        Image(uiImage: image)
