...
@MainActor
public struct NEMOChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: NEMOChatViewModel
    ...
    private var visibleMessages: [NEMOChatMessage] {
        let base: [NEMOChatMessage]
    ...
    private func mergeToolResults(in messages: [NEMOChatMessage]) -> [NEMOChatMessage] {
    ...
    private func isToolResultMessage(_ message: NEMOChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: NEMOChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: NEMOChatMessage) -> String {
