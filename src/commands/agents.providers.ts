...
function resolveDefaultAccountId(cfg: NEMOConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: NEMOConfig): boolean {
...
export function summarizeBindings(cfg: NEMOConfig, bindings: AgentBinding[]): string[] {
