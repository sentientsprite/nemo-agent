...
export function applyZaiConfig(cfg: NEMOConfig): NEMOConfig {
...
export function applyOpenrouterProviderConfig(cfg: NEMOConfig): NEMOConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: NEMOConfig): NEMOConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: NEMOConfig): NEMOConfig {
...
export function applyOpenrouterConfig(cfg: NEMOConfig): NEMOConfig {
...
export function applyLitellmProviderConfig(cfg: NEMOConfig): NEMOConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyLitellmConfig(cfg: NEMOConfig): NEMOConfig {
...
export function applyMoonshotProviderConfig(cfg: NEMOConfig): NEMOConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: NEMOConfig): NEMOConfig {
...
export function applyMoonshotConfig(cfg: NEMOConfig): NEMOConfig {
...
export function applyMoonshotConfigCn(cfg: NEMOConfig): NEMOConfig {
...
export function applyKimiCodeProviderConfig(cfg: NEMOConfig): NEMOConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: NEMOConfig): NEMOConfig {
...
export function applySyntheticProviderConfig(cfg: NEMOConfig): NEMOConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: NEMOConfig): NEMOConfig {
...
export function applyXiaomiProviderConfig(cfg: NEMOConfig): NEMOConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: NEMOConfig): NEMOConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: NEMOConfig): NEMOConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: NEMOConfig): NEMOConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: NEMOConfig): NEMOConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: NEMOConfig): NEMOConfig {
...
export function applyXaiProviderConfig(cfg: NEMOConfig): NEMOConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: NEMOConfig): NEMOConfig {
...
export function applyQianfanProviderConfig(cfg: NEMOConfig): NEMOConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: NEMOConfig): NEMOConfig {
