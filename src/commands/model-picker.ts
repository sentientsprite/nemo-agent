...
function resolveConfiguredModelRaw(cfg: NEMOConfig): string {
...
function resolveConfiguredModelKeys(cfg: NEMOConfig): string[] {
...
export function applyPrimaryModel(cfg: NEMOConfig, model: string): NEMOConfig {
...
export function applyModelAllowlist(cfg: NEMOConfig, models: string[]): NEMOConfig {
  const defaults = cfg.agents?.defaults;
