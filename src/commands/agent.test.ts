...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "nemo-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<NEMOConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<NEMOConfig["telegram"]>>,
