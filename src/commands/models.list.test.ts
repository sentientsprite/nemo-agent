...
const ensureNEMOModelsJson = vi.fn().mockResolvedValue(undefined);
const resolveNEMOAgentDir = vi.fn().mockReturnValue("/tmp/nemo-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/nemo-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensureNEMOModelsJson,
}));
