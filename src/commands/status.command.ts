...
export async function statusCommand(
  ...
  runtime.log(theme.heading("NEMO status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("nemo security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("nemo security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.nemo.ai/faq");
  runtime.log("Troubleshooting: https://docs.nemo.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("nemo status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("nemo logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("nemo status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("nemo gateway probe")}`);
  }
}
