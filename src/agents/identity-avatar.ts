...
function resolveAvatarSource(cfg: NEMOConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: NEMOConfig, agentId: string): AgentAvatarResolution {
