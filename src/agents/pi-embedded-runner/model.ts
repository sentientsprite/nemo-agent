...
// pi-ai's built-in Anthropic catalog can lag behind NEMO's defaults/docs.
...
export function buildModelAliasLines(cfg?: NEMOConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveNEMOAgentDir();
