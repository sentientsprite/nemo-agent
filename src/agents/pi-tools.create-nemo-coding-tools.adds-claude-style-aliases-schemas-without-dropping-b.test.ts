...
describe("createNEMOCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createNEMOCodingTools({
      config,
    ...
    const anthropicTools = createNEMOCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createNEMOCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createNEMOCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
