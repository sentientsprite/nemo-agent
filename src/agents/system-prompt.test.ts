...
describe("buildAgentSystemPrompt", () => {
  ...
  it("includes a CLI quick reference section", () => {
    ...
    expect(prompt).toContain("## NEMO CLI Quick Reference");
    expect(prompt).toContain("nemo gateway restart");
  ...
  it("preserves tool casing in the prompt", () => {
    ...
    expect(prompt).toContain("NEMO docs: /tmp/nemo/docs");
    expect(prompt).toContain(
  ...
  // See: https://github.com/nemo-agent/nemo-agent/commit/66eec295b894bce8333886cfbca3b960c57c4946
  // Agents should use session_status or message timestamps to determine the date/time.
  // Related: https://github.com/nemo-agent/nemo-agent/issues/1897
  //          https://github.com/nemo-agent/nemo-agent/issues/3658
  it("does NOT include a date or time in the system prompt (cache stability)", () => {
    ...
    // https://github.com/nemo-agent/nemo-agent/issues/3658 for the preferred approach:
  ...
  it("adds ClaudeBot self-update guidance when gateway tool is available", () => {
    ...
    expect(prompt).toContain("## NEMO Self-Update");
