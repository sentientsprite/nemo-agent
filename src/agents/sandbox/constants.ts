...
export const DEFAULT_SANDBOX_IMAGE = "nemo-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "nemo-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "nemo-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "nemo-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "nemo-sbx-browser-";
