...
function resolveWatchPaths(workspaceDir: string, config?: NEMOConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: NEMOConfig }) {
