...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.NEMO_STATE_DIR;
  const configPath = env.NEMO_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    NEMO_PROFILE: profile,
    NEMO_STATE_DIR: stateDir,
    NEMO_CONFIG_PATH: configPath,
    NEMO_GATEWAY_PORT: String(port),
    NEMO_GATEWAY_TOKEN: token,
    NEMO_LAUNCHD_LABEL: resolvedLaunchdLabel,
    NEMO_SYSTEMD_UNIT: systemdUnit,
    NEMO_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    NEMO_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    NEMO_STATE_DIR: stateDir,
    NEMO_CONFIG_PATH: configPath,
    NEMO_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    NEMO_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    NEMO_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    NEMO_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    NEMO_LOG_PREFIX: "node",
    NEMO_SERVICE_MARKER: NODE_SERVICE_MARKER,
    NEMO_SERVICE_KIND: NODE_SERVICE_KIND,
    NEMO_SERVICE_VERSION: VERSION,
  };
}
