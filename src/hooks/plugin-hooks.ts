...
import type { NEMOPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: NEMOPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: NEMOPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
