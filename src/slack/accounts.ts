...
export function listSlackAccountIds(cfg: NEMOConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: NEMOConfig): string {
...
function mergeSlackAccountConfig(cfg: NEMOConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: NEMOConfig): ResolvedSlackAccount[] {
