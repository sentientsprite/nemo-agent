...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "nemo-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveNEMOPackageRoot } = await import("./nemo-root.js");
    ...
    vi.mocked(resolveNEMOPackageRoot).mockResolvedValue("/opt/nemo");
