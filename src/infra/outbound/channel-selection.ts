...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: NEMOConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: NEMOConfig): Promise<MessageChannelId[]> {
