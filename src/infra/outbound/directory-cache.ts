...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: NEMOConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: NEMOConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: NEMOConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: NEMOConfig): void {
