...
import { type NEMOConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: NEMOConfig): string[] {
...
export function listAgentsForGateway(cfg: NEMOConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: NEMOConfig): string {
...
function resolveSessionStoreAgentId(cfg: NEMOConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: NEMOConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: NEMOConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: NEMOConfig): GatewaySessionsDefaults {
