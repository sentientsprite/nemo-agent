...
export function resolveHooksConfig(cfg: NEMOConfig): HooksConfigResolved | null {
...
function resolveKnownAgentIds(cfg: NEMOConfig, defaultAgentId: string): Set<string> {
