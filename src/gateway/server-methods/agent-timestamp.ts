 ...
 *
 * @see https://github.com/nemo-agent/nemo-agent/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an NEMOConfig.
 */
export function timestampOptsFromConfig(cfg: NEMOConfig): TimestampInjectionOptions {
  return {
