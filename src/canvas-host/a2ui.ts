...
export const A2UI_PATH = "/__nemo__/a2ui";

export const CANVAS_HOST_PATH = "/__nemo__/canvas";

export const CANVAS_WS_PATH = "/__nemo__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.nemoCanvasA2UIAction.postMessage(...)
  // - Android: window.nemoCanvasA2UIAction.postMessage(...)
  const handlerNames = ["nemoCanvasA2UIAction"];
  ...
  globalThis.NEMO = globalThis.NEMO ?? {};
  globalThis.NEMO.postMessage = postToNode;
  globalThis.NEMO.sendUserAction = sendUserAction;
  globalThis.nemoPostMessage = postToNode;
  globalThis.nemoSendUserAction = sendUserAction;
