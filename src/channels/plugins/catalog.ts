...
import type { NEMOPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverNEMOPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, NEMOPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["NEMO_PLUGIN_CATALOG_PATHS", "NEMO_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<NEMOPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: NEMOPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverNEMOPlugins({ workspaceDir: options.workspaceDir });
