...
export type ChannelAgentToolFactory = (params: { cfg?: NEMOConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: NEMOConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: NEMOConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: NEMOConfig }) => boolean;
  supportsCards?: (params: { cfg: NEMOConfig }) => boolean;
