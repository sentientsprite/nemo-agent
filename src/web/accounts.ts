...
export function listWhatsAppAuthDirs(cfg: NEMOConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: NEMOConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: NEMOConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: NEMOConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: NEMOConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: NEMOConfig): ResolvedWhatsAppAccount[] {
