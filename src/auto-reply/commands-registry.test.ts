...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@nemo", { botUsername: "nemo" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@nemo args", {
        botUsername: "nemo",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "nemo" })).toBe("/help@otherbot");
  });
