...
function resolveMentionPatterns(cfg: NEMOConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: NEMOConfig | undefined, agentId?: string): RegExp[] {
