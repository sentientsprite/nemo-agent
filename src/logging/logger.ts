...
export const DEFAULT_LOG_DIR = "/tmp/nemo";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "nemo.log"); // legacy single-file path

const LOG_PREFIX = "nemo";
...
function resolveSettings(): ResolvedSettings {
  let cfg: NEMOConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => NEMOConfig;
      };
