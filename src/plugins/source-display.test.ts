...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/nemo/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/nemo/extensions",
        global: "/Users/x/.nemo/extensions",
        workspace: "/Users/x/ws/.nemo/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.nemo/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/nemo/extensions",
        global: "/Users/x/.nemo/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.nemo/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/nemo/extensions",
        global: "/Users/x/.nemo/extensions",
