...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @nemo/voice-call -> voice-call).
...
export function discoverNEMOPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".nemo", "extensions")];
