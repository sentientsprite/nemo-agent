...
function resolveAnthropicDefaultAuthMode(cfg: NEMOConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: NEMOConfig): NEMOConfig {
...
export function applyTalkApiKey(config: NEMOConfig): NEMOConfig {
...
export function applyModelDefaults(cfg: NEMOConfig): NEMOConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: NEMOConfig): NEMOConfig {
...
export function applyLoggingDefaults(cfg: NEMOConfig): NEMOConfig {
...
export function applyContextPruningDefaults(cfg: NEMOConfig): NEMOConfig {
...
export function applyCompactionDefaults(cfg: NEMOConfig): NEMOConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
