...
${formatHelpExamples([
  ['nemo message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'nemo message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'nemo message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.nemo.ai/cli/message")}`,
    )
    .action(() => {
