const DEFAULT_TAGLINE = "All your chats, one NEMO.";
...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little nemo-sistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  "Your terminal just grew nemos—type something and let the bot pinch the busywork.",
  ...
  "Automation with nemos: minimal fuss, maximal pinch.",
  ...
  "NEMOs out, commit in—let's ship something mildly responsible.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.NEMO_TAGLINE_INDEX;
