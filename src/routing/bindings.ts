...
export function listBindings(cfg: NEMOConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: NEMOConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: NEMOConfig) {
