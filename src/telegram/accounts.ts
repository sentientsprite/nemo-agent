...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.NEMO_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: NEMOConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: NEMOConfig): string {
...
function mergeTelegramAccountConfig(cfg: NEMOConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: NEMOConfig): ResolvedTelegramAccount[] {
