...
# 🦞 NEMO — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/nemo/nemo/main/docs/assets/nemo-logo-text-dark.png">
        <img src="https://raw.githubusercontent.com/nemo/nemo/main/docs/assets/nemo-logo-text.png" alt="NEMO" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/nemo/nemo/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/nemo/nemo/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/nemo/nemo/releases"><img src="https://img.shields.io/github/v/release/nemo/nemo?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/nemod"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**NEMO** is a _personal AI assistant_ you run on your own devices.
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, Microsoft Teams, WebChat), plus extension channels like BlueBubbles, Matrix, Zalo, and Zalo Personal. It can speak and listen on macOS/iOS/Android, and can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://nemo.ai) · [Docs](https://docs.nemo.ai) · [DeepWiki](https://deepwiki.com/nemo/nemo) · [Getting Started](https://docs.nemo.ai/start/getting-started) · [Updating](https://docs.nemo.ai/install/updating) · [Showcase](https://docs.nemo.ai/start/showcase) · [FAQ](https://docs.nemo.ai/start/faq) · [Wizard](https://docs.nemo.ai/start/wizard) · [Nix](https://github.com/nemo/nix-nemo) · [Docker](https://docs.nemo.ai/install/docker) · [Discord](https://discord.gg/nemod)

Preferred setup: run the onboarding wizard (`nemo onboard`) in your terminal.
The wizard guides you step by step through setting up the gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
Works with npm, pnpm, or bun.
New install? Start here: [Getting started](https://docs.nemo.ai/start/getting-started)
...
Model note: while any model is supported, I strongly recommend **Anthropic Pro/Max (100/200) + Opus 4.6** for long‑context strength and better prompt‑injection resistance. See [Onboarding](https://docs.nemo.ai/start/onboarding).

## Models (selection + auth)

- Models config + CLI: [Models](https://docs.nemo.ai/concepts/models)
- Auth profile rotation (OAuth vs API keys) + fallbacks: [Model failover](https://docs.nemo.ai/concepts/model-failover)

If you use a local config file that references an LM Studio token (like `"apiKey": "${LM_STUDIO_TOKEN}"`), set the token via an environment variable and keep it out of git history:
...
Full beginner guide (auth, pairing, channels): [Getting started](https://docs.nemo.ai/start/getting-started)

```bash
nemo onboard --install-daemon

nemo gateway --port 18789 --verbose

# Send a message
nemo message send --to +1234567890 --message "Hello from NEMO"

# Talk to the assistant (optionally deliver back to any connected channel: WhatsApp/Telegram/Slack/Discord/Google Chat/Signal/iMessage/BlueBubbles/Microsoft Teams/Matrix/Zalo/Zalo Personal/WebChat)
nemo agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.nemo.ai/install/updating) (and run `nemo doctor`).
...
Switch channels (git + npm): `nemo update --channel stable|beta|dev`.
Details: [Development channels](https://docs.nemo.ai/install/development-channels).
...
pnpm nemo onboard --install-daemon

# Dev loop (auto-reload on TS changes)
pnpm gateway:watch
```

Note: `pnpm nemo ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `nemo` binary.

## Security defaults (DM access)

NEMO connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.nemo.ai/gateway/security)

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dm.policy="pairing"` / `channels.slack.dm.policy="pairing"`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `nemo pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.dm.allowFrom` / `channels.slack.dm.allowFrom`).

Run `nemo doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.nemo.ai/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.nemo.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, BlueBubbles (iMessage), iMessage (legacy), Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.nemo.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.nemo.ai/nodes/voicewake) + [Talk Mode](https://docs.nemo.ai/nodes/talk)** — always-on speech for macOS/iOS/Android with ElevenLabs.
- **[Live Canvas](https://docs.nemo.ai/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.nemo.ai/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.nemo.ai/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.nemo.ai/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.nemo.ai/nodes).
- **[Onboarding](https://docs.nemo.ai/start/wizard) + [skills](https://docs.nemo.ai/tools/skills)** — wizard-driven setup with bundled/managed/workspace skills.

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=nemo/nemo&type=date&legend=top-left)](https://www.star-history.com/#nemo/nemo&type=date&legend=top-left)

## Everything we built so far

### Core platform

- [Gateway WS control plane](https://docs.nemo.ai/gateway) with sessions, presence, config, cron, webhooks, [Control UI](https://docs.nemo.ai/web), and [Canvas host](https://docs.nemo.ai/platforms/mac/canvas#canvas-a2ui).
- [CLI surface](https://docs.nemo.ai/tools/agent-send): gateway, agent, send, [wizard](https://docs.nemo.ai/start/wizard), and [doctor](https://docs.nemo.ai/gateway/doctor).
- [Pi agent runtime](https://docs.nemo.ai/concepts/agent) in RPC mode with tool streaming and block streaming.
- [Session model](https://docs.nemo.ai/concepts/session): `main` for direct chats, group isolation, activation modes, queue modes, reply-back. Group rules: [Groups](https://docs.nemo.ai/concepts/groups).
- [Media pipeline](https://docs.nemo.ai/nodes/images): images/audio/video, transcription hooks, size caps, temp file lifecycle. Audio details: [Audio](https://docs.nemo.ai/nodes/audio).

### Channels

- [Channels](https://docs.nemo.ai/channels): [WhatsApp](https://docs.nemo.ai/channels/whatsapp) (Baileys), [Telegram](https://docs.nemo.ai/channels/telegram) (grammY), [Slack](https://docs.nemo.ai/channels/slack) (Bolt), [Discord](https://docs.nemo.ai/channels/discord) (discord.js), [Google Chat](https://docs.nemo.ai/channels/googlechat) (Chat API), [Signal](https://docs.nemo.ai/channels/signal) (signal-cli), [BlueBubbles](https://docs.nemo.ai/channels/bluebubbles) (iMessage, recommended), [iMessage](https://docs.nemo.ai/channels/imessage) (legacy imsg), [Microsoft Teams](https://docs.nemo.ai/channels/msteams) (extension), [Matrix](https://docs.nemo.ai/channels/matrix) (extension), [Zalo](https://docs.nemo.ai/channels/zalo) (extension), [Zalo Personal](https://docs.nemo.ai/channels/zalouser) (extension), [WebChat](https://docs.nemo.ai/web/webchat).
- [Group routing](https://docs.nemo.ai/concepts/group-messages): mention gating, reply tags, per-channel chunking and routing. Channel rules: [Channels](https://docs.nemo.ai/channels).

### Apps + nodes

- [macOS app](https://docs.nemo.ai/platforms/macos): menu bar control plane, [Voice Wake](https://docs.nemo.ai/nodes/voicewake)/PTT, [Talk Mode](https://docs.nemo.ai/nodes/talk) overlay, [WebChat](https://docs.nemo.ai/web/webchat), debug tools, [remote gateway](https://docs.nemo.ai/gateway/remote) control.
- [iOS node](https://docs.nemo.ai/platforms/ios): [Canvas](https://docs.nemo.ai/platforms/mac/canvas), [Voice Wake](https://docs.nemo.ai/nodes/voicewake), [Talk Mode](https://docs.nemo.ai/nodes/talk), camera, screen recording, Bonjour pairing.
- [Android node](https://docs.nemo.ai/platforms/android): [Canvas](https://docs.nemo.ai/platforms/mac/canvas), [Talk Mode](https://docs.nemo.ai/nodes/talk), camera, screen recording, optional SMS.
- [macOS node mode](https://docs.nemo.ai/nodes): system.run/notify + canvas/camera exposure.

### Tools + automation

- [Browser control](https://docs.nemo.ai/tools/browser): dedicated nemo Chrome/Chromium, snapshots, actions, uploads, profiles.
- [Canvas](https://docs.nemo.ai/platforms/mac/canvas): [A2UI](https://docs.nemo.ai/platforms/mac/canvas#canvas-a2ui) push/reset, eval, snapshot.
- [Nodes](https://docs.nemo.ai/nodes): camera snap/clip, screen record, [location.get](https://docs.nemo.ai/nodes/location-command), notifications.
- [Cron + wakeups](https://docs.nemo.ai/automation/cron-jobs); [webhooks](https://docs.nemo.ai/automation/webhook); [Gmail Pub/Sub](https://docs.nemo.ai/automation/gmail-pubsub).
- [Skills platform](https://docs.nemo.ai/tools/skills): bundled, managed, and workspace skills with install gating + UI.

### Runtime + safety

- [Channel routing](https://docs.nemo.ai/concepts/channel-routing), [retry policy](https://docs.nemo.ai/concepts/retry), and [streaming/chunking](https://docs.nemo.ai/concepts/streaming).
- [Presence](https://docs.nemo.ai/concepts/presence), [typing indicators](https://docs.nemo.ai/concepts/typing-indicators), and [usage tracking](https://docs.nemo.ai/concepts/usage-tracking).
- [Models](https://docs.nemo.ai/concepts/models), [model failover](https://docs.nemo.ai/concepts/model-failover), and [session pruning](https://docs.nemo.ai/concepts/session-pruning).
- [Security](https://docs.nemo.ai/gateway/security) and [troubleshooting](https://docs.nemo.ai/channels/troubleshooting).

### Ops + packaging

- [Control UI](https://docs.nemo.ai/web) + [WebChat](https://docs.nemo.ai/web/webchat) served directly from the Gateway.
- [Tailscale Serve/Funnel](https://docs.nemo.ai/gateway/tailscale) or [SSH tunnels](https://docs.nemo.ai/gateway/remote) with token/password auth.
- [Nix mode](https://docs.nemo.ai/install/nix) for declarative config; [Docker](https://docs.nemo.ai/install/docker)-based installs.
- [Doctor](https://docs.nemo.ai/gateway/doctor) migrations, [logging](https://docs.nemo.ai/logging).
...
- **[Gateway WebSocket network](https://docs.nemo.ai/concepts/architecture)** — single WS control plane for clients, tools, and events (plus ops: [Gateway runbook](https://docs.nemo.ai/gateway)).
- **[Tailscale exposure](https://docs.nemo.ai/gateway/tailscale)** — Serve/Funnel for the Gateway dashboard + WS (remote access: [Remote](https://docs.nemo.ai/gateway/remote)).
- **[Browser control](https://docs.nemo.ai/tools/browser)** — nemo‑managed Chrome/Chromium with CDP control.
- **[Canvas + A2UI](https://docs.nemo.ai/platforms/mac/canvas)** — agent‑driven visual workspace (A2UI host: [Canvas/A2UI](https://docs.nemo.ai/platforms/mac/canvas#canvas-a2ui)).
- **[Voice Wake](https://docs.nemo.ai/nodes/voicewake) + [Talk Mode](https://docs.nemo.ai/nodes/talk)** — always‑on speech and continuous conversation.
- **[Nodes](https://docs.nemo.ai/nodes)** — Canvas, camera snap/clip, screen record, `location.get`, notifications, plus macOS‑only `system.run`/`system.notify`.

## Tailscale access (Gateway dashboard)

NEMO can auto-configure Tailscale **Serve** (tailnet-only) or **Funnel** (public) while the Gateway stays bound to loopback. Configure `gateway.tailscale.mode`:
...
- `gateway.bind` must stay `loopback` when Serve/Funnel is enabled (NEMO enforces this).
- Serve can be forced to require a password by setting `gateway.auth.mode: "password"` or `gateway.auth.allowTailscale: false`.
- Funnel refuses to start unless `gateway.auth.mode: "password"` is set.
- Optional: `gateway.tailscale.resetOnExit` to undo Serve/Funnel on shutdown.

Details: [Tailscale guide](https://docs.nemo.ai/gateway/tailscale) · [Web surfaces](https://docs.nemo.ai/web)
...
Details: [Remote access](https://docs.nemo.ai/gateway/remote) · [Nodes](https://docs.nemo.ai/nodes) · [Security](https://docs.nemo.ai/gateway/security)
...
Details: [Nodes](https://docs.nemo.ai/nodes) · [macOS app](https://docs.nemo.ai/platforms/macos) · [Gateway protocol](https://docs.nemo.ai/concepts/architecture)
...
Details: [Session tools](https://docs.nemo.ai/concepts/session-tool)

## Skills registry (NEMOHub)

NEMOHub is a minimal skill registry. With NEMOHub enabled, the agent can search for skills automatically and pull in new ones as needed.

[NEMOHub](https://nemohub.com)
...
- Controlled via `nemo nodes …`.

Runbook: [iOS connect](https://docs.nemo.ai/platforms/ios).

### Android node (optional)

- Pairs via the same Bridge + pairing flow as iOS.
- Exposes Canvas, Camera, and Screen capture commands.
- Runbook: [Android connect](https://docs.nemo.ai/platforms/android).

## Agent workspace + skills

- Workspace root: `~/.nemo/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.nemo/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.nemo/nemo.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.nemo.ai/gateway/configuration)
...
Details: [Security guide](https://docs.nemo.ai/gateway/security) · [Docker + sandboxing](https://docs.nemo.ai/install/docker) · [Sandbox config](https://docs.nemo.ai/gateway/configuration)

### [WhatsApp](https://docs.nemo.ai/channels/whatsapp)

- Link the device: `pnpm nemo channels login` (stores creds in `~/.nemo/credentials`).
- Allowlist who can talk to the assistant via `channels.whatsapp.allowFrom`.
- If `channels.whatsapp.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Telegram](https://docs.nemo.ai/channels/telegram)
...
### [Slack](https://docs.nemo.ai/channels/slack)

- Set `SLACK_BOT_TOKEN` + `SLACK_APP_TOKEN` (or `channels.slack.botToken` + `channels.slack.appToken`).

### [Discord](https://docs.nemo.ai/channels/discord)
...
### [Signal](https://docs.nemo.ai/channels/signal)

- Requires `signal-cli` and a `channels.signal` config section.

### [BlueBubbles (iMessage)](https://docs.nemo.ai/channels/bluebubbles)

- **Recommended** iMessage integration.
- Configure `channels.bluebubbles.serverUrl` + `channels.bluebubbles.password` and a webhook (`channels.bluebubbles.webhookPath`).
- The BlueBubbles server runs on macOS; the Gateway can run on macOS or elsewhere.

### [iMessage (legacy)](https://docs.nemo.ai/channels/imessage)

- Legacy macOS-only integration via `imsg` (Messages must be signed in).
- If `channels.imessage.groups` is set, it becomes a group allowlist; include `"*"` to allow all.

### [Microsoft Teams](https://docs.nemo.ai/channels/msteams)

- Configure a Teams app + Bot Framework, then add a `msteams` config section.
- Allowlist who can talk via `msteams.allowFrom`; group access via `msteams.groupAllowFrom` or `msteams.groupPolicy: "open"`.

### [WebChat](https://docs.nemo.ai/web/webchat)
...
- [Start with the docs index for navigation and “what’s where.”](https://docs.nemo.ai)
- [Read the architecture overview for the gateway + protocol model.](https://docs.nemo.ai/concepts/architecture)
- [Use the full configuration reference when you need every key and example.](https://docs.nemo.ai/gateway/configuration)
- [Run the Gateway by the book with the operational runbook.](https://docs.nemo.ai/gateway)
- [Learn how the Control UI/Web surfaces work and how to expose them safely.](https://docs.nemo.ai/web)
- [Understand remote access over SSH tunnels or tailnets.](https://docs.nemo.ai/gateway/remote)
- [Follow the onboarding wizard flow for a guided setup.](https://docs.nemo.ai/start/wizard)
- [Wire external triggers via the webhook surface.](https://docs.nemo.ai/automation/webhook)
- [Set up Gmail Pub/Sub triggers.](https://docs.nemo.ai/automation/gmail-pubsub)
- [Learn the macOS menu bar companion details.](https://docs.nemo.ai/platforms/mac/menu-bar)
- [Platform guides: Windows (WSL2)](https://docs.nemo.ai/platforms/windows), [Linux](https://docs.nemo.ai/platforms/linux), [macOS](https://docs.nemo.ai/platforms/macos), [iOS](https://docs.nemo.ai/platforms/ios), [Android](https://docs.nemo.ai/platforms/android)
- [Debug common failures with the troubleshooting guide.](https://docs.nemo.ai/channels/troubleshooting)
- [Review security guidance before exposing anything.](https://docs.nemo.ai/gateway/security)

## Advanced docs (discovery + control)

- [Discovery + transports](https://docs.nemo.ai/gateway/discovery)
- [Bonjour/mDNS](https://docs.nemo.ai/gateway/bonjour)
- [Gateway pairing](https://docs.nemo.ai/gateway/pairing)
- [Remote gateway README](https://docs.nemo.ai/gateway/remote-gateway-readme)
- [Control UI](https://docs.nemo.ai/web/control-ui)
- [Dashboard](https://docs.nemo.ai/web/dashboard)

## Operations & troubleshooting

- [Health checks](https://docs.nemo.ai/gateway/health)
- [Gateway lock](https://docs.nemo.ai/gateway/gateway-lock)
- [Background process](https://docs.nemo.ai/gateway/background-process)
- [Browser troubleshooting (Linux)](https://docs.nemo.ai/tools/browser-linux-troubleshooting)
- [Logging](https://docs.nemo.ai/logging)

## Deep dives

- [Agent loop](https://docs.nemo.ai/concepts/agent-loop)
- [Presence](https://docs.nemo.ai/concepts/presence)
- [TypeBox schemas](https://docs.nemo.ai/concepts/typebox)
- [RPC adapters](https://docs.nemo.ai/reference/rpc)
- [Queue](https://docs.nemo.ai/concepts/queue)

## Workspace & skills

- [Skills config](https://docs.nemo.ai/tools/skills-config)
- [Default AGENTS](https://docs.nemo.ai/reference/AGENTS.default)
- [Templates: AGENTS](https://docs.nemo.ai/reference/templates/AGENTS)
- [Templates: BOOTSTRAP](https://docs.nemo.ai/reference/templates/BOOTSTRAP)
- [Templates: IDENTITY](https://docs.nemo.ai/reference/templates/IDENTITY)
- [Templates: SOUL](https://docs.nemo.ai/reference/templates/SOUL)
- [Templates: TOOLS](https://docs.nemo.ai/reference/templates/TOOLS)
- [Templates: USER](https://docs.nemo.ai/reference/templates/USER)

## Platform internals

- [macOS dev setup](https://docs.nemo.ai/platforms/mac/dev-setup)
- [macOS menu bar](https://docs.nemo.ai/platforms/mac/menu-bar)
- [macOS voice wake](https://docs.nemo.ai/platforms/mac/voicewake)
- [iOS node](https://docs.nemo.ai/platforms/ios)
- [Android node](https://docs.nemo.ai/platforms/android)
- [Windows (WSL2)](https://docs.nemo.ai/platforms/windows)
- [Linux app](https://docs.nemo.ai/platforms/linux)

## Email hooks (Gmail)

- [docs.nemo.ai/gmail-pubsub](https://docs.nemo.ai/automation/gmail-pubsub)

## NEMO

NEMO was built for **NEMO**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [nemo.ai](https://nemo.ai)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@nemo](https://x.com/nemo)
...
<p align="left">
  ...
  <a href="https://github.com/ryancnelson"><img src="https://avatars.githubusercontent.com/u/347171?v=4&s=48" width="48" height="48" alt="ryancnelson" title="ryancnelson"/></a> <a href="https://github.com/search?q=Samrat%20Jha"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="Samrat Jha" title="Samrat Jha"/></a> <a href="https://github.com/search?q=seans-nemobot"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="seans-nemobot" title="seans-nemobot"/></a> <a href="https://github.com/senoldogann"><img src="https://avatars.githubusercontent.com/u/45736551?v=4&s=48" width="48" height="48" alt="senoldogann" title="senoldogann"/></a> <a href="https://github.com/Seredeep"><img src="https://avatars.githubusercontent.com/u/22802816?v=4&s=48" width="48" height="48" alt="Seredeep" title="Seredeep"/></a> <a href="https://github.com/sergical"><img src="https://avatars.githubusercontent.com/u/3760543?v=4&s=48" width="48" height="48" alt="sergical" title="sergical"/></a> <a href="https://github.com/search?q=shatner"><img src="assets/avatar-placeholder.svg" width="48" height="48" alt="shatner" title="shatner"/></a> <a href="https://github.com/shiv19"><img src="https://avatars.githubusercontent.com/u/9407019?v=4&s=48" width="48" height="48" alt="shiv19" title="shiv19"/></a> <a href="https://github.com/shiyuanhai"><img src="https://avatars.githubusercontent.com/u/1187370?v=4&s=48" width="48" height="48" alt="shiyuanhai" title="shiyuanhai"/></a> <a href="https://github.com/Shrinija17"><img src="https://avatars.githubusercontent.com/u/199155426?v=4&s=48" width="48" height="48" alt="Shrinija17" title="Shrinija17"/></a>
