...
export function listGoogleChatAccountIds(cfg: NEMOConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: NEMOConfig): string {
...
function mergeGoogleChatAccountConfig(cfg: NEMOConfig, accountId: string): GoogleChatAccountConfig {
...
export function listEnabledGoogleChatAccounts(cfg: NEMOConfig): ResolvedGoogleChatAccount[] {
