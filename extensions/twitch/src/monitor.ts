...
import type { ReplyPayload, NEMOConfig } from "nemo/plugin-sdk";
import { createReplyPrefixOptions } from "nemo/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as NEMOConfig;
