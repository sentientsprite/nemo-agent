...
export function listZalouserAccountIds(cfg: NEMOConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: NEMOConfig): string {
...
function mergeZalouserAccountConfig(cfg: NEMOConfig, accountId: string): ZalouserAccountConfig {
