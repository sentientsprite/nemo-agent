...
import type { NEMOPluginApi, NEMOPluginToolContext } from "../../../src/plugins/types.js";
import { createLobsterTool } from "./lobster-tool.js";

async function writeFakeLobsterScript(scriptBody: string, prefix = "nemo-lobster-plugin-") {
...
function fakeApi(overrides: Partial<NEMOPluginApi> = {}): NEMOPluginApi {
  return {
    id: "lobster",
    name: "lobster",
    source: "test",
...
function fakeCtx(overrides: Partial<NEMOPluginToolContext> = {}): NEMOPluginToolContext {
  return {
    config: {},
    workspaceDir: "/tmp",
    agentDir: "/tmp",
...
describe("lobster plugin tool", () => {
  ...
  it("can be gated off in sandboxed contexts", async () => {
    const api = fakeApi();
    const factoryTool = (ctx: NEMOPluginToolContext) => {
      if (ctx.sandboxed) {
        return null;
      }
