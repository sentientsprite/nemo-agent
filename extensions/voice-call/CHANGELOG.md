...
- Version alignment with core NEMO release numbers.
...
- First public release of the @nemo/voice-call plugin.
...
- CLI: `nemo voicecall` commands (call/start/continue/speak/end/status/tail/expose).
