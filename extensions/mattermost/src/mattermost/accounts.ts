...
export function listMattermostAccountIds(cfg: NEMOConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: NEMOConfig): string {
...
export function listEnabledMattermostAccounts(cfg: NEMOConfig): ResolvedMattermostAccount[] {
