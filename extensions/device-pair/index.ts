...
import { approveDevicePairing, listDevicePairing } from "nemo/plugin-sdk";
...
async function resolveTailnetHost(api: NEMOPluginApi): Promise<string | null> {
...
function resolveAuth(cfg: NEMOPluginApi["config"]): ResolveAuthResult {
...
async function resolveGatewayUrl(api: NEMOPluginApi): Promise<ResolveUrlResult> {
