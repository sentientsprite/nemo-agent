...
Nostr DM channel plugin for NEMO using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to NEMO. It enables your bot to:
...
# Configure nemo to use local relay
