...
export function listBlueBubblesAccountIds(cfg: NEMOConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: NEMOConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: NEMOConfig): ResolvedBlueBubblesAccount[] {
