...
This directory contains the **BlueBubbles external channel plugin** for NEMO.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `nemo/plugin-sdk` helpers.
