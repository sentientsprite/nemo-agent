...
vi.mock("nemo/plugin-sdk", async () => {
  const actual = await vi.importActual<typeof import("nemo/plugin-sdk")>("nemo/plugin-sdk");
  return {
    ...actual,
...
import { emitDiagnosticEvent } from "nemo/plugin-sdk";
...
describe("diagnostics-otel service", () => {
  ...
  test("records message-flow metrics and spans", async () => {
    ...
    expect(spanNames).toContain("nemo.webhook.processed");
    expect(spanNames).toContain("nemo.message.processed");
    expect(spanNames).toContain("nemo.session.stuck");
