...
# Output:
# - dist/NEMO.app
# - dist/NEMO-<version>.zip
# - dist/NEMO-<version>.dmg
...
ZIP="$ROOT_DIR/dist/NEMO-$VERSION.zip"
DMG="$ROOT_DIR/dist/NEMO-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/NEMO-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/NEMO-$VERSION.dSYM.zip"
